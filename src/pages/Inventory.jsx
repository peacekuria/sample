...
const TEMPLATES = {
  ...
  '2BR': ['2 Beds', 'Sofa', 'Dining Table', 'Fridge', 'Washing Machine', 'Boxes']
}
      ...
      <div className="inventory-content">
        ...
        <div className="card mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Inventory Checklist</h2>
              <p className="text-gray-600 mt-1">Organize your move room by room</p>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm font-medium text-gray-900">{completedCount} of {items.length} items</p>
        ...
        <div className="card">
          ...
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">No items yet. Add items above or select a template.</p>
            </div>
          ) : (
            <ul className="space-y-3">
              {items.map((it, i) => (
                ...
                >
                  ...
                  <span className={`flex-1 text-gray-900 ${it.done ? 'line-through text-gray-400' : ''}`}>
                    {it.text}
                  </span>
                  <button
        ...
        <div className="card mt-6">
          <p className="text-sm text-gray-500">
            <span className="font-medium text-gray-700">Current role:</span> {user ? user.role : 'guest'}
          </p>
        </div>
      </div>
    </div>
