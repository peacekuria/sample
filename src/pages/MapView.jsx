  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="card mb-6">
        ...
        <p className="text-gray-600 mt-1">Pin locations for accurate quotes and real-time tracking</p>
      </div>
            ...
            <div className="h-[400px] bg-gray-100 rounded-xl overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400">Enter an address to view location</p>
                </div>
              </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="card">
            ...
            <div className={`p-4 rounded-xl mb-4 ${
              trackingStatus === 'active' ? 'bg-green-50 border border-green-100' : 
              trackingStatus === 'pinning' ? 'bg-indigo-50 border border-indigo-100' :
              'bg-gray-50 border border-gray-100'
            }`}>
              <div className="flex items-center gap-3">
                <div className={`h-10 w-10 rounded-full flex items-center justify-center ${
                  trackingStatus === 'active' ? 'bg-green-100' : 
                  trackingStatus === 'pinning' ? 'bg-indigo-100' :
                  'bg-gray-200'
                }`}>
                ...
                <div>
                  <p className="font-medium text-gray-900">
                    {trackingStatus === 'active' ? 'Tracking Active' : 
                     trackingStatus === 'pinning' ? 'Pinning Location...' : 
                     'Not Tracking'}
                  </p>
                  <p className="text-sm text-gray-500">
                    {trackingStatus === 'active' ? 'Real-time updates enabled' : 
          ...
          <div className="card">
            ...
            <div className="space-y-3">
              <button className="w-full p-3 text-left rounded-xl border border-gray-100 hover:border-indigo-200 hover:bg-indigo-50 transition-colors">
                ...
                <p className="text-sm text-gray-500">Use GPS to pin current location</p>
              </button>
              <button className="w-full p-3 text-left rounded-xl border border-gray-100 hover:border-indigo-200 hover:bg-indigo-50 transition-colors">
                <p className="font-medium text-gray-900">Saved Locations</p>
                <p className="text-sm text-gray-500">Access previously saved addresses</p>
              </button>
              <button className="w-full p-3 text-left rounded-xl border border-gray-100 hover:border-indigo-200 hover:bg-indigo-50 transition-colors">
