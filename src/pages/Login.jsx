...
export default function Login({ onSuccess }) {
  ...
  const MailIcon = () => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="input-icon" aria-hidden>
      <path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8" stroke="#9CA3AF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <rect x="3" y="5" width="18" height="14" rx="2" stroke="#9CA3AF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
    ...
    <div className="login-container">
      ...
      <div className="login-card">
        ...
        <div className="social-group">
          <button className="btn-social" onClick={() => handleSocialDemo('google')}>
            <img src="https://www.google.com/favicon.ico" width="16" alt="Google" />
            Google
          </button>
          <button className="btn-social" onClick={() => handleSocialDemo('github')}>
            <GithubIcon />
            GitHub
          </button>
          {/* Demo Admin for local development/testing */}
          <button className="btn-social" onClick={() => handleSocialDemo('admin')}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: 8 }}>
              <path d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5z" stroke="#374151" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M4 20c0-4 4-6 8-6s8 2 8 6" stroke="#374151" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Demo Admin
          </button>
        </div>
        ...
        <p className="signup-text">
          Don't have an account? <span onClick={() => handleSocialDemo('client')}>Sign up</span>
        </p>
      </div>
